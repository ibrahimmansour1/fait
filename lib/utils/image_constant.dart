class ImageConstant {
  ...
  // on boarding_sign up images
  static String imgUser = '$imagePath/img_user.svg';

  // splash2_One images
  static String imgImageSplash = '$imagePath/img_image_splash.png';

  // splash2-Two images
  static String imgSplash12 = '$imagePath/img_splash1_2.png';

  // splash2-Three images
  static String imgDeitImage = '$imagePath/img_deit_image.png';

  static String imgArrowrightBlack900 =
      '$imagePath/img_arrowright_black_900.svg';

  // Daily intake images
  static String imgPercentages = '$imagePath/img_percentages.svg';

  static String imgGroup7 = '$imagePath/img_group_7.svg';

  // water intake images
  static String imgCountWaterIntake = '$imagePath/img_count_water_intake.svg';

  static String imgDrunkpart = '$imagePath/img_drunkpart.svg';
  ...
  // Sleep tracker images
  static String imgGroup12 = '$imagePath/img_group_12.png';

  static String imgIconamoonAtten = '$imagePath/img_iconamoon_atten.svg';
  ...
  static String imgRunningFemaleAmber400 =
      '$imagePath/img_running_female_amber_400.svg';

  static String imgPointAround = '$imagePath/img_point_around.svg';

  static String imgRectangle24x24 = '$imagePath/img_rectangle_24x24.png';
  ...
  static String imgTrophyRed100 = '$imagePath/img_trophy_red_100.svg';

  static String imgTrophyRed10064x64 =
      '$imagePath/img_trophy_red_100_64x64.svg';

  static String imgFloatingIcon = '$imagePath/img_floating_icon.svg';

  // home2_after login images
  static String imgContrast = '$imagePath/img_contrast.svg';

  static String imgBottomPartInfo = '$imagePath/img_bottom_part_info.svg';

  static String imgTodaySStatusIcon = '$imagePath/img_today_s_status_icon.svg';
  ...
  // Common images
  static String imgFait = '$imagePath/img_fait.png';

  static String imgFait128x128 = '$imagePath/img_fait_128x128.png';
  ...
  static String imgRulerSlider = '$imagePath/img_ruler_slider.svg';

  static String imgMenuIcon = '$imagePath/img_menu_icon.svg';

  static String imgSleepchart = '$imagePath/img_sleepchart.svg';

  static String imgSteps = '$imagePath/img_steps.svg';

  static String imgAddOrMinusCup = '$imagePath/img_add_or_minus_cup.svg';

  static String imgArrowRightOnprimarycontainer =
      '$imagePath/img_arrow_right_onprimarycontainer.svg';

  static String imgSidebarCard = '$imagePath/img_sidebar_card.svg';
  ...
  static String imgClockGreen400 = '$imagePath/img_clock_green_400.svg';

  static String imgVectorOrangeA200 = '$imagePath/img_vector_orange_a200.svg';
  ...
  static String imgProtiens = '$imagePath/img_protiens.svg';

  static String imgChangeIcon = '$imagePath/img_change_icon.svg';

  static String imgMeals156x56 = '$imagePath/img_meals_1_56x56.png';

  static String imgSidebarCardOnprimarycontainer156x40 =
      '$imagePath/img_sidebar_card_onprimarycontainer_156x40.svg';

  static String imgCardImage = '$imagePath/img_card_image.png';

  static String imgInfo = '$imagePath/img_info.svg';

  static String imgCalories16x16 = '$imagePath/img_calories_16x16.png';
  ...
  static String imgImage80x80 = '$imagePath/img_image_80x80.png';
